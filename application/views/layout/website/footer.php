<footer>
	<section class="containerSections">
		<address class="contactContainer">
			...
			<div class="itemContact">
				<img src="/codeigniter/public/img/email-footer.png" alt="Ícone de um telefone nas cores branca e verde">
				<div class="itemContactInfos">
					<span>Email</span>
					<span>contato@contoebilancio.com.br</span>
				</div>
			</div>
	...
	<p id="footerText">© Copyright Conto & Bilancio - <?php echo date("Y"); ?></p>
</footer>

<a title="Fale conosco pelo WhatsApp" href="https://wa.me/554192865530?text=Ol%C3%A1%2C%20vim%20atrav%C3%A9s%20do%20website%20pelo%20link%20do%20WhatsApp.%20Gostaria%20da%20seguinte%20informa%C3%A7%C3%A3o%3A" target="_blank" id="whatsapp">
